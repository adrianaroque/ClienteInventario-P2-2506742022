...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 5. Sincronizar inventario con la API del proveedor
            ...
            System.out.println("Error al leer o escribir el archivo JSON: "
                    + e.getMessage());

        } catch (InterruptedException e) {
            System.out.println("La sincronizacion fue interrumpida: "
                    + e.getMessage());
